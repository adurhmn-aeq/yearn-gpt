  ...
  return (
    <div
      className={`group min-w-[150px] cursor-pointer ${
        agent.disabled ? "bg-[#8080803d]" : "bg-[rgba(255, 255, 255, 0.2)]"
      } p-[7px] rounded-[18px] shadow-[0px_4px_10px_0px_#00000029,10px_10px_30px_0px_#00000005_inset] border-4 border-solid border-[#FFFFFF] hover:scale-110 transform transition-transform w-[155px]`}
    >
      <div className=" h-[100%] rounded-[18px] flex flex-col justify-center items-center gap-2">
        <img src="/providers/botImg.svg" alt="" />
        <h2
          className={`text-[20px] ${
            agent.disabled ? "text-[#343538]" : "group-hover:text-[#51DC00]"

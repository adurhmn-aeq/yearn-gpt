...
const pillActiveClass =
  " items-center justify-center transition-colors disabled:pointer-events-none relative py-2 px-6 bg-[#FFFFFF] rounded-[50px] shadow-[0px_1px_2px_0px_#0000000F]";
const pillInActiveClass =
  " items-center justify-center transition-colors disabled:pointer-events-none relative py-2 px-6";
        ...
        <div className="flex justify-center">
          {fetchLoading ? (
            ...
            <button
              ...
              className="inline-flex items-center justify-center whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-80 bg-zinc-900 shadow hover:bg-zinc-800/90 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-50/90 h-9 px-4 mt-12 w-full rounded-[10px] py-2 text-center text-sm font-semibold text-white"
            >

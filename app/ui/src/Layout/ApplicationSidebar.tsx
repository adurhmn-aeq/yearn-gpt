      ...
      <div className="flex flex-col justify-between h-full">
        <div className="flex flex-col">
          <SidebarItem
            ...
            className="px-2 pt-[14px] rounded-md"
            leftSlot={
              <>
                <svg
                  width="42"
          ...
          <div className="flex flex-col gap-[4px]">
            ...
            >
              <span className="text-sm font-normal text-secondary-500 dark:text-copy-50 dark:opacity-60">
                Home
              </span>
            </SidebarItem>
          </div>
          ...
          <div className="flex flex-col gap-[4px]">
            ...
            >
              <span className="text-sm font-normal text-secondary-500 dark:text-copy-50 dark:dark:opacity-60">
                Audio Agent
              </span>
            </SidebarItem>
          </div>

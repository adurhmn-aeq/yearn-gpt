...
export const ApplicationSidebar = () => {
  ...
  return (
    <aside
      className={[
        `px-4 py-4 transition transition-all duration-300 bg-[#F9F9F8] min-h-full overflow-auto`,
        ...
        <div className="flex flex-col h-full">
          <div className="flex flex-col gap-[4px] h-full">
              ...
              {NavRoutes.map((val, i) => (
                <Link key={i} to={"/"}>
                  <SidebarItem
                    ...
                    className="px-3 h-[48px] rounded-lg hover:bg-[#3435381A] dark:bg-[#151a25] cursor-pointer"
                    leftSlot={<>{val.icon}</>}
                  >
            ...
            <div className="border border-solid border-[#343538] rounded-[20px] px-[15px] py-[20px] flex flex-col justify-center items-center w-full gap-[20px] mt-2">
              ...
              <button className="flex gap-2 bg-[#51DC00] px-[15px] h-[45px] justify-center items-center rounded-[10px] text-[16px] font-[500] text-[#343538] min-w-[172px] shadow-[0px_0px_10px_0px_#0000000F,2px_4px_4px_0px_#FFFFFF8C_inset]">
                Upgrade <img src="/providers/upgrade.svg" alt="" />
              </button>
            </div>
            ...
            <div className="flex justify-center items-center mt-[auto] pt-[30px]">

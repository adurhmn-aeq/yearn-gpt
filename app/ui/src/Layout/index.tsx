...
export default function DashboardLayout({
  ...
  return (
    <>
      <main
        className={`bg-[#F9F9F8] dark:bg-secondary-500 text-neutral-700 min-h-screen`}
      >
        <div className="flex flex-col min-h-screen">
          ...
          <Disclosure as="nav" className="">
            {() => (
              <>
                <div className="mx-auto px-2 sm:px-6 lg:px-12 pt-4">
                  <div className="flex justify-between">
                    ...
                    <div className=" ml-6 flex items-center gap-1">
                      ...
                      >
                        <h1 className="text-secondary-500 dark:text-copy-500 dark:text-opacity-60 text-sm">
                          Usage
                        </h1>
                      </Link>
                      <Link
          ...
          <div className="py-4 sm:px-2 px-4 lg:px-8 flex-1">
            <div className="bg-white dark:bg-[#0b0f19] rounded-3xl border-[1px] border-[#f3f3f1] dark:border-[#151a25] overflow-y-scroll min-h-[90vh]">
              <>{children}</>
            </div>
          </div>
        </div>

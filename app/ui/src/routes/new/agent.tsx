  ...
  return (
    <>
      <div className="flex min-h-full flex-col py-12 sm:px-6 lg:px-8 font-work_sans">
        <div className="w-full items-center sm:mx-auto sm:w-full sm:max-w-md flex flex-col gap-0">
          ...
          <h2 className="mt-6 text-center text-xl capitalize font-medium tracking-tight text-secondary-500 dark:text-copy-500">
            Create a new agent
          </h2>
          <p className="text-center text-lg font-work_sans font-normal text-secondary-500 dark:text-gray-200">
            Fill the form to create an agent
          </p>
        </div>
        <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-lg">
          <div className="bg-white py-7 px-7 border border-[#e9efe6] sm:rounded-3xl dark:bg-[#0f141f] dark:border-[#151a25] dark:shadow-[0 1px 4px #080b1136] font-work_sans shadow-[0_1px_2px_0_rgb(228,229,231,0.24)]">
            {/* <BotForm
